...
function email_form_submission($form) {
	...
	$mail->SMTPAuth = true;
	$mail->Username = 'doctorandresrojasmedpsiquiatra@gmail.com'; // update this line
	$mail->Password = 'passwordaqui'; // update this line
	// $mail->SMTPSecure = 'tls'; // leave this commented out

	$mail->From = 'doctorandresrojasmedpsiquiatra@gmail.com';
	$mail->FromName = 'doctorandresrojasmedpsiquiatra@gmail.com';
	$mail->addAddress($to);
	$mail->isHTML(true);
